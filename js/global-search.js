        ...
        this.searchData = [
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: 'NOMCOS', description: 'Skincare made simple. UK-based vegan skincare brand offering products for oily & acne prone skin, uneven tones & dark spots, dry skin, and body care', keywords: 'nomcos, skincare, simple, vegan, uk, oily skin, acne prone, dark spots, dry skin, body care, hemp face butter, cloud body butter, purifying cleansing oil', url: 'https://www.nomcos.co.uk/' }
                ]
            },
            {
                page: 'makeup.html',
                ...
                content: [
                    ...
                    { title: 'Glisten Cosmetics', description: 'UK woman-owned independent beauty brand specializing in colourful makeup products. Water-activated liners, cosmetic paints, duochrome pigments, colourful foundations, mascaras, lip products. PETA certified cruelty-free', keywords: 'glisten cosmetics, uk, woman-owned, colourful makeup, water-activated liners, cosmetic paints, duochrome, peta certified, cruelty-free, creative beauty, indie brand', url: 'https://www.glistencosmetics.com/' },
                    ...
                    { title: 'Crown Cosmetics', description: 'UK-based artisan beauty brand offering healthy skincare products and vegan makeup. Specializing in vegan makeup boxes and The Royal Vitamin E Super-Lip Gloss line', keywords: 'crown cosmetics, uk, artisan, vegan makeup, lip gloss, cruelty-free, natural ingredients, vitamin e, makeup boxes', url: 'https://www.crowncosmeticsltd.com/vegan-makeup' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: 'Bare Kind Bamboo Socks', description: 'Plush bamboo socks that save animals with 10% of profits donated to wildlife charities', keywords: 'bare kind, bamboo socks, wildlife charities, animal rescue, sustainable socks, plastic free packaging, uk designed socks, kids socks, adult socks', url: 'https://www.awin1.com/cread.php?s=3407453&v=30533&q=451822&r=2576869' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: "Catherine's Originals", description: 'Handcrafted vegan chocolates with fairly traded cocoa, naturally gluten-free recipes, and fully recyclable packaging', keywords: 'catherines originals, vegan chocolate, gluten-free, recyclable packaging, fair trade cocoa, plant-based chocolate', url: 'https://catherinesoriginals.com/' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: 'Unity Diner', description: 'Featured in Vogue Best Vegan Restaurants in London. Proudly vegan, non-profit, and sustainable restaurant in Spitalfields offering 100% vegan carvery every Sunday & Bank holiday Monday', keywords: 'unity diner, london, spitalfields, vegan carvery, non-profit, sustainable, vogue, wentworth street, aldgate east, liverpool street', url: 'https://www.unitydiner.co.uk/' }
                ]
            },
            {
            ...
            },
            {
                ...
                content: [
                    ...
                    { title: 'The Saucy Cow', description: 'Big, dirty vegan food in the heart of Dublin! Fun, colourful and inclusive restaurant on Crane Lane in Temple Bar. Great tunes, good atmosphere, and always the best vibes. Online ordering available with locations in Dublin Temple Bar and Cork Marina Market. The best vegan restaurant experience in Dublin City', keywords: 'the saucy cow, dublin, temple bar, crane lane, vegan restaurant, cork marina market, online ordering, big dirty vegan, fun atmosphere, great vibes, plant-based, 100% vegan', url: 'https://www.thesaucycow.com/' }
                ]
            },
            {
                ...
                content: [
                    ...
                    { title: 'The Vegan Sora', description: 'The finest vegan dining experience in Edinburgh. Home of Sora Lella and Sora Diana restaurants, offering distinct Italian vegan cuisine experiences. Sora Lella features bold Roman flavours while Sora Diana brings modern Italian classics with inspired cocktails. 100% vegan Italian-owned restaurant, voted best Scottish vegan/vegetarian establishment 2025', keywords: 'the vegan sora, sora lella, sora diana, edinburgh, italian vegan, vegan restaurant, roman flavours, italian classics, cocktails, best scottish vegan, oceania awards, italian awards, 2025', url: 'https://www.thevegansora.com/' },
                    ...
                    { title: 'Happy Fish at The Dog House', description: 'Scotland\'s first fully vegan fish and chip restaurant located within The Dog House pub in Edinburgh. 100% plant-based menu featuring banana blossom \'fish\' and chips, battered sausages, and vegan haggis. Dog-friendly with a cozy atmosphere for diners', keywords: 'happy fish, the dog house, edinburgh, scotland, vegan fish and chips, first vegan fish and chip, banana blossom, battered sausages, vegan haggis, dog-friendly, plant-based, 100% vegan', url: 'https://www.instagram.com/thehappyfishvg/' }
                ]
            },
            {
            ...
            {
                page: 'bristol-restaurants.html',
                title: 'Bristol Restaurants',
                url: 'bristol-restaurants.html',
                content: [
                    { title: 'Bristol Restaurants', description: 'Vegan restaurants in Bristol', keywords: 'bristol, restaurants, vegan bristol, bristol dining, uk restaurants', url: 'bristol-restaurants.html' },
                    { title: 'Plantuguese', description: 'The UK\'s ONLY 100% Vegan Portuguese Restaurant. Experience authentic plant-based Portuguese cuisine in the heart of Bristol at 34 Stokescroft', keywords: 'plantuguese, bristol, portuguese restaurant, vegan portuguese, authentic portuguese cuisine, stokescroft, plant-based portuguese, 100% vegan', url: 'https://www.plantuguese.com/' },
                    { title: 'VX Bristol', description: 'The first 100% vegan boutique in the UK, offering vegan junk food menu with kebabs, burgers, milkshakes, cakes, and French patisserie. Also a vegan grocery store with imported vegan goods', keywords: 'vx bristol, bristol, vegan boutique, vegan junk food, kebabs, burgers, vegan grocery, vegan shop, east street, first vegan boutique uk, vegan cakes, vegan milkshakes', url: 'https://www.vxbristol.com/' },
                    { title: 'Oowee Vegan', description: 'The birth place of Oowee Vegan! Plant-based vegan fast food in Bristol at 65 Baldwin Street. Serving deliciously vegan comfort food including cheeseburgers, fries, and milkshakes', keywords: 'oowee vegan, bristol, baldwin street, vegan fast food, vegan burgers, vegan cheeseburgers, vegan milkshakes, plant-based fast food, delivery, click collect', url: 'https://ooweevegan.com/locations/baldwin-street/' },
                    { title: 'Cheung\'s Vegan Kitchen', description: 'Family-run Chinese takeaway established in 1969, now offering an all-vegan menu with traditional Chinese cuisine. Located at 15 Sandhurst Road, Brislington, serving vegan duck, chicken balls, and curry dishes', keywords: 'cheungs vegan kitchen, bristol, brislington, chinese takeaway, vegan chinese, family-run, sandhurst road, vegan duck, vegan chicken balls, established 1969', url: 'https://www.cheungsvegankitchen.com/' },
                    { title: 'Fi Real Caribbean Vegan', description: 'Vegan Caribbean Restaurant in Bristol sharing the experience of Caribbean food in a unique and tasty way. Located at 57 West Street, Old Market', keywords: 'fi real, fireal, bristol, caribbean vegan, vegan caribbean, old market, west street, caribbean cuisine, vegan restaurant bristol', url: 'http://www.fireal.co.uk/' },
                    { title: 'East Village Cafe', description: 'Plant-based cafe in the heart of Clifton Village, Bristol. Serving sandwiches, pastries, homemade cakes, seasonal drinks, iced coffees, smoothies, natural rainbow lattes, and coffee from Triple Co Roast', keywords: 'east village cafe, bristol, clifton village, plant-based cafe, vegan cafe, sandwiches, pastries, cakes, coffee, triple co roast, dog friendly, boyces avenue', url: 'https://www.eastvillagecafe.co.uk/' },
                    { title: 'Vegan India', description: 'Bristol\'s first 100% Vegan Indian restaurant on Gloucester Road. Serving authentic plant-based Indian dishes including chicken korma, kofta chilli masala, and meatless meatballs', keywords: 'vegan india, bristol, gloucester road, vegan indian, indian restaurant, plant-based indian, vegan curry, bristol first vegan indian, chicken korma, kofta', url: 'https://vegan-india.co.uk/' },
                    { title: 'Koocha Mezze Bar', description: 'Bristol\'s first fully vegan restaurant, established in 2018! Persian and Middle Eastern inspired plant-based cuisine. Located at 203B Cheltenham Road, serving mezze dishes, vegan doner kebabs, and signature cocktails', keywords: 'koocha mezze bar, bristol, cheltenham road, persian, middle eastern, vegan mezze, vegan doner kebab, bristol first vegan restaurant, established 2018, plant-based persian', url: 'https://koochamezzebar.com/' }
                ]
            },
            ...
            // Events Page
            {
                ...
                content: [
                    ...
                    { title: 'Lincolnshire Vegan Festival', description: '60+ stalls, cookery demos, and workshops in Lincoln - 30 May 2026', keywords: 'lincolnshire, lincoln, festival, may, 2026, events, vegan events, cookery demos' },
                    { title: 'Bath Vegan Summer Festival', description: '60 vegan stalls with talks and workshops in Bath - 6 June 2026', keywords: 'bath, festival, june, 2026, events, vegan events, summer festival' },
                    { title: 'Cambridgeshire Vegan Festival', description: '60+ stalls, world food, and workshops in Peterborough - 20 June 2026', keywords: 'cambridgeshire, peterborough, festival, june, 2026, events, vegan events, world food' },
                    { title: 'Nottinghamshire Vegan Festival', description: '80+ stalls, talks, and demos in Nottingham - 5 July 2026', keywords: 'nottinghamshire, nottingham, festival, july, 2026, events, vegan events, talks' },
                    { title: 'Staffordshire Vegan Festival', description: '50+ stalls, world food, and workshops in Stoke-on-Trent - 27 September 2026', keywords: 'staffordshire, stoke-on-trent, festival, september, 2026, events, vegan events, world food' },
                    { title: 'Scotland Vegan Autumn Festival', description: '80 stalls across Paisley Lagoon Leisure Centre - 17 October 2026', keywords: 'scotland, paisley, autumn, festival, october, 2026, events, vegan events' },
            ...
            // Support Websites Page
            {
                ...
                content: [
                    ...
                    { title: 'Vegan Hikers Club', description: 'Inclusive UK community hosting vegan-friendly day hikes, weekend adventures, and social meet-ups for plant-powered explorers', keywords: 'vegan hikers club, vegan hiking, uk hikes, vegan adventures, outdoor community, weekend trips, plant-powered pals, inclusive hiking group, vegan meet-ups', url: 'https://veganhikersclub.com/' },
                    { title: 'Vegan Outreach Scotland', description: 'Scottish vegan outreach organization dedicated to making new vegans and saving precious lives. Organizes events and outreach activities across Scotland', keywords: 'vegan outreach scotland, scottish vegan outreach, aberdeenshire, highland moray, angus fife, vegan events scotland, vegan activism scotland, scottish vegan community, roadshow events, vegan calendar scotland', url: 'https://veganoutreachscotland.co.uk/' }
                ]
            },
